...
void CompareSkylines()
{
   ...
   GDALDataset* poDS1 = (GDALDataset*)GDALOpenEx( filepath1.c_str(), GDAL_OF_VECTOR, NULL, NULL, NULL );
   ...
   GDALDataset* poDS2 = (GDALDataset*)GDALOpenEx( filepath2.c_str(), GDAL_OF_VECTOR, NULL, NULL, NULL );
