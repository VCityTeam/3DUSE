...
*/
citygml::CityModel* TileCityGML_assign( vcity::Tile* Tile, std::vector<TextureCityGML*>* TexturesList, TVec2d MinTile, TVec2d MaxTile, std::string PathFolder )
{
...
/**
* @brief Decoupe le fichier CityGML en un ensemble de tuiles dont la taille est definie en entree. Les geometries sont ici decoupees selon les contours de tuile.
* @param Tile : Contient les donnees du fichier CityGML ouvert : il doit contenir un ensemble de batiments LOD2 ou du terrain
* @param TexturesList : La fonction va remplir ce vector avec tous les appels de texture qu'il faudra enregistrer dans le CityGML en sortie;
* @param MinTile : Coordonnee du coin bas gauche de la tuile
* @param MaxTile : Coordonnee du coin haut droit de la tuile
*/
citygml::CityModel* TileCityGML_cut( vcity::Tile* Tile, std::vector<TextureCityGML*>* TexturesList, TVec2d MinTile, TVec2d MaxTile, std::string PathFolder )
{
   citygml::CityModel* Tuile = new citygml::CityModel;
