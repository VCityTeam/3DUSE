...
LRing PutLRingOnTerrain(LRing ring)
{
	...
	AABBCollection boxes = LoadAABB("C:/VCityData/Tile/");//TODO: Get Dir Tile from dialogVisibilite
	...
	for(unsigned int i = 0; i < ptResult.size(); i++)
	{
		...
		{
			std::string path = "C:/VCityData/Tile/" + ptAABB[i].name;//TOO: Change Tile dir
